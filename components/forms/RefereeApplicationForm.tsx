      ...
      <Card>
        <div className="text-center py-8">
          ...
          <p className="text-gray-600 mb-4">
            Thank you for your interest in becoming an {orgConfig.labels.official.toLowerCase()}. We&apos;ll review your application and contact you soon with next steps.
          </p>
      ...
      >
        ...
        <div className="mb-6">
          ...
          >
            ...
            <option value="local-association">Local Sports Association</option>
            <option value="community-league">Community League</option>
            <option value="youth-program">Youth Sports Program</option>
